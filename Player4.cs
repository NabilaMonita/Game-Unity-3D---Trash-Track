...
public class Player4 : MonoBehaviour
{
    ...
    private int apelCount = 0; // Inisialisasi variabel apel

    public Text botolText; // UI Text element untuk menampilkan jumlah botol
    public Text donatText; // UI Text element untuk menampilkan jumlah donat
    public Text apelText; // UI Text element untuk menampilkan jumlah apel
    ...
    void Start()
    {
        ...
        UpdateApelText(); // Update UI apel pada awal permainan
    }
    ...
    void GetApel(Collider other)
    {
        apelCount++;
        UpdateApelText(); // Update UI setiap kali mendapatkan apel
        other.gameObject.SetActive(false);
    }
    ...
    void UpdateApelText()
    {
        if (apelText != null)
        {
            apelText.text = apelCount.ToString();
        }
    }
